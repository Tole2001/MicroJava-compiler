...
public class DesStmtList extends DesignatorStatementLocalList {

    private DesignatorStatement DesignatorStatement;
    private DesignatorStatementLocalList DesignatorStatementLocalList;

    public DesStmtList (DesignatorStatement DesignatorStatement, DesignatorStatementLocalList DesignatorStatementLocalList) {
